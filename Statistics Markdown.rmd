...
#flood means
mean(duration_df[duration_df$inout == "flood" & duration_df$tod_start=="day",]$duration_min)
sd(duration_df[duration_df$inout == "flood" & duration_df$tod_start=="day",]$duration_min)
mean(duration_df[duration_df$inout == "flood" & duration_df$tod_start=="night",]$duration_min)
sd(duration_df[duration_df$inout == "flood" & duration_df$tod_start=="night",]$duration_min)

#ebb means
mean(duration_df[duration_df$inout == "ebb" & duration_df$tod_start=="day",]$duration_min)
sd(duration_df[duration_df$inout == "ebb" & duration_df$tod_start=="day",]$duration_min)
mean(duration_df[duration_df$inout == "ebb" & duration_df$tod_start=="night",]$duration_min)
sd(duration_df[duration_df$inout == "ebb" & duration_df$tod_start=="night",]$duration_min)
...
plot_all
#ggsave("C:\\Users\\BESCBEAR\\OneDrive - Liverpool John Moores University\\Synced files\\Projects\\1_NIOZ projects\\2_DayNight\\figures\\fig_3.eps", plot_all,units="cm", height=16, width =16, device="eps")

```

# For supplementary fig S1 ####
